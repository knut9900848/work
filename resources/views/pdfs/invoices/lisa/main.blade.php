	...
	<footer>
		<div class="wrap-bottom">
			...
			<div class="signature">
				...
				@endif
				<ul>
					<li>APPROVED BY <b>{{ $invoice->invoice_approvers->first()->manager->name }}</b></li>
					<li></li>
					<li><b>{{ $invoice->invoice_approvers->first()->manager->position }}</b></li>
				</ul>
			</div>

			<div class="signature">
				<img src="{{ public_path('img') }}/stamps/empty.jpg" width="150" />
				<ul>
					<li>CONFIRMED BY <b>{{ $invoice->requestor->name }}</b></li>
					<li><b>{{ $invoice->requestor->position }}</b></li>
