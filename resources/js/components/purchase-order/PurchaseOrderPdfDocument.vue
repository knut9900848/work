...
export default {
  ...
  computed: {
    ...
    ...mapState("purchase_order", ["purchaseOrderId"])
  },
  ...
  methods: {
    ...
    initialize() {
      Axios.get(
        "/api/purchase-orders/" + this.purchaseOrderId + "/pdf-documents"
      ).then(response => {
