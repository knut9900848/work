  ...
  methods: {
    ...
    save() {
      if (this.editedIndex > -1) {
        Axios.put('/api/admin/manpower-disciplines/' + this.editedItem.id, this.editedItem)
        .then(response => {
        ...
        Axios.post('/api/admin/manpower-disciplines', this.editedItem)
        .then(response => {
    ...
    deleteItem(item) {
      ...
      if ( confirm("Do you really want to delete?") === true ) {
        Axios.delete('/api/admin/manpower-disciplines/' + item.id)
        .then(response => {
