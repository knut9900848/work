  ...
  methods: {
    ...
    save() {
      if (this.editedIndex > -1) {
        Axios.put("/api/admin/countries/" + this.editedItem.id, this.editedItem)
          .then(response => {
        ...
        Axios.post("/api/admin/countries", this.editedItem)
          .then(response => {
    ...
    deleteItem(item) {
      ...
      if (confirm("Do you really want to delete?") === true) {
        Axios.delete("/api/admin/countries/" + item.id).then(response => {
