...
class PurchaseOrderSubmitted extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('IES PO No. [' . $this->purchaseOrder->number . '] Submitted.')
            ->greeting($greeting)
            ->line('IES PO Number. [' . $this->purchaseOrder->number . '] has been submitted by ' . $this->sender->name)
            ->line('Please review and approve the IES PO.')
